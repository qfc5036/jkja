...
int main(void) {
  ...
  if (grades>=93.0){
    ...
    puts ("Your letter grade for CMPSC131 is B+.");
  }
  else if (grades>=83.0){
    puts ("Your letter grade for CMPSC131 is B.");
  }
    ...
    puts ("Your letter grade for CMPSC131 is C+.");
  }
  else if (grades>=70.0){
    puts ("Your letter grade for CMPSC131 is C.");
  }  
  else if (grades>=60.0){
    puts ("Your letter grade for CMPSC131 is D.");
  }
  else {
    puts ("Your letter grade for CMPSC131 is F.");
  }
  return 0;
}